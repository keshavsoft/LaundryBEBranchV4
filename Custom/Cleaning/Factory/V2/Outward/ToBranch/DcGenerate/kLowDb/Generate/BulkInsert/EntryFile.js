...
import { StartFunc as StartFuncPullData } from "../../../../../../../../../../binV4/FactoryOut_QrCodeScan/CommonPull/kLowDb/CommonFuncs/ReturnDbObjectWithSchema.js";
...
let StartFunc = ({ inArrayFromRequest }) => {
    ...
    LocalReturnData.UserDataFilePath = `${Configjson.JsonPath}/FactoryOut_QrCodeScan.json`;
