...
let LocalFuncForLowDb = () => {
  ...
  LocalReturnData.UserDataFilePath = `${Configjson.jsonConfig.DataPath}/${Configjson.jsonConfig.DataPk}/PurchaseItems.json`;
...
let LocalFuncForTableSchema = () => {
  ...
  let LocalSecondNeeded = Configjson.jsonConfig.tableAndColumns.children.find(element => {
    return "children" in element === false && element.name === "PurchaseItems.json";
  });
