...
const StartFunc = ({ }) => {
  ...
  let LocalinDataToInsert = {ItemInOrder : LocalCoumnItemInOrder,CustomerData : LocalCoumnCustomerData,OrderData : LocalCoumnOrderData,AddOn : LocalCoumnAddOn,CheckOutData : LocalCoumnCheckOutData};
